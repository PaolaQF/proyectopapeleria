    ...
    <div class="col-lg-10">
        ...
        <div class="main-card p-0 overflow-hidden">
            ...
            <div class="form-header">
                ...
                <p>Completa la información de la sucursal</p>
            </div>
                ...
                <form method="POST" action="{{ route('sucursales.store') }}">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control rounded-3" id="telefono" name="telefono" value="{{ old('telefono') }}">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control rounded-3" id="calle" name="calle" value="{{ old('calle') }}">
                        </div>

                        <div class="col-md-4">
                            <label for="numero" class="form-label fw-semibold">Número</label>
                            <input type="number" class="form-control rounded-3" id="numero" name="numero" value="{{ old('numero') }}">
                        </div>

                        <div class="col-md-4">
                            <label for="colonia" class="form-label fw-semibold">Colonia</label>
                            <input type="text" class="form-control rounded-3" id="colonia" name="colonia" value="{{ old('colonia') }}">
                        </div>

                        <div class="col-md-4">
                            <label for="ciudad" class="form-label fw-semibold">Ciudad</label>
                            <input type="text" class="form-control rounded-3" id="ciudad" name="ciudad" value="{{ old('ciudad') }}">
                        </div>

                        <div class="col-md-6">
                            <label for="estado" class="form-label fw-semibold">Estado</label>
                            <input type="text" class="form-control rounded-3" id="estado" name="estado" value="{{ old('estado') }}">
                        </div>

                        <div class="col-md-6">
                            <label for="codigo_postal" class="form-label fw-semibold">Código Postal</label>
                            <input type="number" class="form-control rounded-3" id="codigo_postal" name="codigo_postal" value="{{ old('codigo_postal') }}">
                        </div>

                        <div class="col-md-6">
                            <label for="fecha_apertura" class="form-label fw-semibold">Fecha de Apertura</label>
                            <input type="date" class="form-control rounded-3" id="fecha_apertura" name="fecha_apertura" value="{{ old('fecha_apertura') }}">
                        </div>
